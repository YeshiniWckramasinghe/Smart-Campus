...
const LecturerDashboard = ({ user }) => {
  const myBookings = [
    ...
    { id: 3, facility: 'Meeting Room', date: '2026-04-08', time: '10:00 - 11:00', status: 'PENDING' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <p className="text-blue-300 text-sm font-medium">Lecturer Dashboard</p>
          ...
          <div className="hidden md:flex items-center space-x-3 
            ...
            <div>
              ...
              <p className="text-blue-300 text-xs">Lecturer</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { icon: '📋', label: 'My Bookings', value: '3', color: 'border-blue-500' },
            { icon: '✅', label: 'Approved', value: '1', color: 'border-green-500' },
            { icon: '⏳', label: 'Pending', value: '2', color: 'border-yellow-500' },
